...
export const metadata: Metadata = buildPageMetadata({
  title: 'Datenschutz',
  description: 'Wie Version2 Ihre personenbezogenen Daten erhebt, nutzt und schützt.',
  routeKey: 'privacy-policy',
})

export default async function DatenschutzPage() {
  const page = await parsePage('politika-privatnosti', 'de')
  ...
  return (
    <main id="main-content" className="flex-1">
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Datenschutz', url: `${SITE_URL}/de/datenschutz/` },
      ]} />
      <LegalPageContent

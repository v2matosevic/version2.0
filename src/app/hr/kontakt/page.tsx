...
export const metadata: Metadata = buildPageMetadata({
  title: 'Kontakt',
  description: 'Kontaktirajte Version2. Razgovarajmo o vašem sljedećem web projektu.',
  routeKey: 'contact',
})
  ...
  return (
    <main id="main-content" className="flex-1">
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Kontakt', url: `${SITE_URL}/hr/kontakt/` },
      ]} />
      <JsonLd data={{
        ...
        description: 'Kontaktirajte Version2. Razgovarajmo o vašem sljedećem web projektu.',
        url: `${SITE_URL}/hr/kontakt/`,
        mainEntity: { '@id': `${SITE_URL}/#business` },
      }} />
      <PageHero
        headline="Imate projekt? Pitanje? Ideju?"
        subtext="Odgovaramo unutar 24 sata. Obično brže."
      />
      <ContentSection background="raised" heading="Pošaljite nam poruku" id="contact-form">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_auto]">
          ...
          <div className="flex flex-col gap-6 lg:pt-20">
            ...
            <a href="https://wa.me/385995617706" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 hover:opacity-80 transition-opacity">
              ...
              <span className="text-foreground">Pošaljite WhatsApp poruku</span>
            </a>
            <div className="flex items-start gap-3">
              <MapPin size={20} className="text-brand-red shrink-0 mt-0.5" />
              <span className="text-muted">Novigradska 21, 23000 Zadar</span>
            </div>
            <div className="flex items-start gap-3">
              <Clock size={20} className="text-brand-red shrink-0 mt-0.5" />
              <span className="text-muted">Pon-Pet, 08:00-16:00 CET</span>
            </div>
          </div>
        </div>
      </ContentSection>
